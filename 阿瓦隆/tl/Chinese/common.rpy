...
translate Chinese strings:
    ...
    new "此菜单上的选项旨在提高可访问性。它们可能不适用于所有游戏，某些选项组合可能会导致游戏无法玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，请尽量保持文本大小与原来相同。"
    ...
    new "该程序包含许多许可证下的自由软件，包括麻省理工学院许可证和GNU Lesser通用公共许可证。可以找到完整的软件列表，包括完整源代码的链接{a=https://www.renpy.org/l/license}在这里{/a}."
    ...
    new "自言自语会说\"[renpy.display.tts.last]\".按“alt+shift+V”禁用。"

    # renpy/common/00preferences.rpy:603
    old "Self-voicing enabled. Press 'v' to disable."
    new "自动发声功能已启用。按“v”禁用。"
    ...
    new "其图形驱动程序可能已过时或运行不正常。这可能会导致图形显示速度慢或不正确。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "这个{a=edit:1:日志txt}log.txt{/a}该文件可能包含帮助您确定计算机故障的信息。"
    ...
    new "复制回溯。txt文件作为BBcode发送到剪贴板，如https://lemmasoft.renai.us/."
    ...
    new "复制回溯。将txt文件添加到剪贴板，作为不一致的标记。"
